...
public class MultiLineChartActivity extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener,
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        for (int z = 0; z < 3; z++) {
            ...
            for (int i = 0; i < dataLength/3; i++) {
                try{
                    temp = Integer.parseInt(data[i*3+z]);
            ...
            switch(z){
                case 0:
                    d = new LineDataSet(values, "高压");
                    break;
                case 1:
                    d = new LineDataSet(values, "低压");
                    break;
                case 2:
                    d = new LineDataSet(values, "心率");
                    break;
                default:
                    break;
            }
...
//                    requestStoragePermission(chart);
    ...
    protected void saveToGallery(LineChart chart, String multiLineChartActivity) {
        saveToGallery(chart, "MultiLineChartActivity");
    }
